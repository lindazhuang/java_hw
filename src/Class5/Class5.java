...
class MyDate {
  public void showCommonDate(){
	...
	before.setTime(4396267507921L);        	//須為長整數 1d-24h-60m-60s 日期比大小可以用
...
class MyBigDecimal{
  ...
  // 初始化陷阱
  public void trick(){
	System.out.println("1.25959 float  => " + new BigDecimal(1.25959));    //不精確
	System.out.println("1.25959 Double => " + new BigDecimal(new Double(1.25959)));//不精確
	System.out.println("1.25959 String => " + new BigDecimal("1.25959")); //初始盡量用string
  }
...
class MyCalendar {
  ...
  public void testBetween(){
	...
	System.out.println(daysBetween(birth, now)); // 顯示 0？ begin為物件在function內都會被影響
  }
